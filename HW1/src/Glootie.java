...
public class Glootie {
	...
	public double getAlphaFactor() {
		//TODO: Implement this
		return Math.floor(sigmoid(0.1 + 0.5 * this.getAge()/70 + 0.5 * this.getKarma()/130) * 1000);
	}
	...
	public boolean equals(Object obj) {
		if(this.getAlphaFactor() == ((Glootie) obj).getAlphaFactor() && this.getPlanet() != ((Glootie) obj).getPlanet())
			return true;
		return false;
	}
