...
public class BinaryTreeNode<T> {
    ...
    public static void main(String[] args) {
		// Create a BinaryTreeNode that holds data of type Integer //6, 4, 3, 5, 8, 9, 1, 2
        BinaryTreeNode<Integer> root = new BinaryTreeNode<Integer>(6); // data value is 1
		// Create all the other nodes...
        BinaryTreeNode<Integer> n2 = new BinaryTreeNode<Integer>(4); // data value is 1
        BinaryTreeNode<Integer> n3 = new BinaryTreeNode<Integer>(3); // data value is 1
        BinaryTreeNode<Integer> n4 = new BinaryTreeNode<Integer>(5); // data value is 1
        BinaryTreeNode<Integer> n5 = new BinaryTreeNode<Integer>(8); // data value is 1
        BinaryTreeNode<Integer> n6 = new BinaryTreeNode<Integer>(9); // data value is 1
        BinaryTreeNode<Integer> n7 = new BinaryTreeNode<Integer>(1); // data value is 1
        BinaryTreeNode<Integer> n8 = new BinaryTreeNode<Integer>(2); // data value is 1
        

		//TODO: Add your code here to build a Binary Search Tree based on the provided input values 
        root.setLeft(n2);// adding 4
        n2.setLeft(n3); //adding 3
        n2.setRight(n4); //adding 5
        root.setRight(n5); //adding 8
        n5.setRight(n6); //adding 9
        n3.setLeft(n7); //adding 1
        n7.setRight(n8); //adding 2
